...
<MobileElementEntity>
   ...
   <locator>new UiSelector().className(&quot;android.view.ViewGroup&quot;).packageName(&quot;com.example.mikebanks.bankscorpfinancial&quot;).enabled(true).clickable(true).longClickable(false).checkable(false).checked(false).focusable(false).focused(false).scrollable(false).selected(false).index(0)</locator>
